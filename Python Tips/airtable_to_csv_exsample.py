# โปรแกรมนี้ผมไม่ได้สร้างขึ้นเอง เพียงแค่ดัดแปลงเล็กน้อยเพื่อใช้งาน และต้องการเผยแพร่ต่อให้เพื่อนๆที่ประสบปัญหาเดียวกันได้แก้ปัญหาได้
# เครดิตทั้งหมดเป็นของผู้สร้าง คุณ Kaleb Nyquist

# ผลงานต้นฉบับ: https://gist.github.com/KalebNyquist/4424fc1ef3dc6bb4fc0b5a7122ada4bc
# บทความต้นฉบับเจ้าของผลงาน: https://towardsdatascience.com/downloading-airtable-data-into-python-89e5c7107a24
...
# กำหนดชื่อ table ใส่ api key, base id ที่เราต้องการให้เรียบร้อย
#    ชื่อ table ก๊อปมาจาก airtable ได้เลย
#    api_key หาได้จากที่: https://airtable.com/account
#    base_id หาได้จากที่: https://airtable.com/api
data = airtable_download('your table name', api_key='keyxxxxxxxxxxx', base_id='appxxxxxxxxxxxx')

# แปลงเป็น dataframe
df = convert_to_dataframe(data)

# ตรวจสอบข้อมูลเบื้องต้นก่อนส่งออก
#df.head()
#df.info()
#df.describe()

# กำหนด path ในเครื่องของเราเพื่อ export เป็น csv ไปใช้งานกับโปรแกรมอื่นต่อเช่น tableau prep builder หรือ tableau desktop
df.to_csv(r'D:\Tableau Hyper\Airtable Data Project/data_from_airtable.csv', index = False,encoding='utf8',header=True,sep='|')